...
//   const fillLength = (remaining / total) * circumference;
  
//   // Handle edge cases for proper rendering
//   let strokeDasharray;
//   if (remaining >= total) {
//     strokeDasharray = `${circumference} 0`; // Full circle
//   } else if (remaining <= 0) {
//     strokeDasharray = `0 ${circumference}`; // Empty circle
//   } else {
//     strokeDasharray = `${fillLength} ${circumference}`; // Partial fill
//   }
  
//   const used = total - remaining;
//   console.log({ total, remaining, used, fillLength, strokeDasharray });
...
//       {used < total ? (<div className={styles.donutMeta}>{used} / {total} used</div>) : (<div className={styles.donutMeta}>{total} / {total} used</div>)}
//     </div>
//   );
// };
